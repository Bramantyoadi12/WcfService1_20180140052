...
namespace WcfService1
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string msg;
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-9DIL2HS;Initial Catalog=MyTestDB;Persist Security Info=True;User ID=sa;Password=bramantyo;Pooling=False");
            con.Open();
